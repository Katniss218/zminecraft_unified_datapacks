...
execute if score __global__ utils matches 0 positioned ~ ~1.62 ~ run function internal:projectiles/sniper/_summon
execute if score __global__ utils matches 1 positioned ~ ~1.62 ~ run function internal:projectiles/sniper_flame/_summon
execute if score __global__ utils matches 2 positioned ~ ~1.62 ~ run function internal:projectiles/sniper_explode/_summon
execute if score __global__ utils matches 3 positioned ~ ~1.62 ~ run function internal:projectiles/sniper_grapeshot/_summon
