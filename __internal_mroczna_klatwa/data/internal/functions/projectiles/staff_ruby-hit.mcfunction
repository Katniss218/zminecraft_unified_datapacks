particle dust 0.95 0.1 0.1 3 ~ ~ ~ 0.5 0.5 0.5 1 12 force @a
...
tag @e[tag=hostile,distance=..2.5] add hitby_ruby
...
effect give @e[tag=hostile,distance=..2.5] slowness 10 1 true
scoreboard players set @e[tag=hostile,distance=..2.5] gem_timer 200
kill @s