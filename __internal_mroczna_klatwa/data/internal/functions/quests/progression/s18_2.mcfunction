...
tellraw @a ["",{"text":"   ► ","color":"dark_gray"},{"text":"Nowy cel: ","color":"gold"},{"text":"Znajdź wejście do groty Królowej Pająków.","color":"gray"}]
tellraw @a {"text":" "}
function internal:quests/sound_begin
#scoreboard players set __global__ q_progression 18
# nadal 18
advancement grant @a until internal:main_quests/pajecza_krolowa/1